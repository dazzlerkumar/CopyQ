...
private slots:
    ...
    void scriptCommandCalledOnce();
    void scriptCommandLoadSettingsCalledOnce();
    void scriptCommandCopyItem();
    void scriptCommandDisplayItem();
    void scriptCommandCopyItemBad();
    void scriptCommandDisplayItemBad();
